  ...
  class ResetTest
    ...
    def execute
      ...
      ActiveRecord::Base.transaction do
        raise StandardError.new("User not found") unless user_service.validate_user_exists(user_id)
      ...
      { status: 200, message: 'Test has been reset. You can now retake the test.' }
    end
  end
end
